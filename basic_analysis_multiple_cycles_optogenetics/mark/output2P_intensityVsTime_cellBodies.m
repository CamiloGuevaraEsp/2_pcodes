...
if (nargin==0),
    rootdir = 'F:\Vishnu-Hrishit 2P intensity files'
    signalMatname = 'TSeries-09112023-0848-085_Cycle00001_Ch2__userDrawnMask__Intensities_3.mat'; %strrep(TProjMask, '.mat','Intensities.mat');
    cycleRankNum = 1; %Set to 0 if there is no voltage being used, otherwise set to 1.
    % Voltage values are hardcoded into the readTimeFromXML script.
    xmlName = 'TSeries-09112023-0848-085.xml';
    numSlices = 47; 
