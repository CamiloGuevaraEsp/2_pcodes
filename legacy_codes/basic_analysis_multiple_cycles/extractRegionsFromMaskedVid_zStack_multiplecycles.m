...
rootdir = 'D:\2p_Imaging\Sara'
% rootdir = 'D:\Hugin\emptyChrimson_HugS3_Arclight';
TSeriesFolder = '20230510 R23E10 ASAP2S Ctrl_2-006'; %_Cycle00001_Ch2__userDrawnMask;
...
TProjMask = '20230510 R23E10 ASAP2S Ctrl_2-006_Cycle00001_Ch2__userDrawnMask.mat';
...
cycleList = [1:1:6962];%:73; %cycleStart:73; %:73; %[2 1046]; %In high speed T-series, just one cycle for the entire series.
cycleArray = 1: max(cycleList);
...
%for(ci = 1:numel(cycleList)),
    ...
    outname = strrep(TProjMask, '.mat',['_' '_' 'Intensities.mat']);
    ...
    regionPropsArray = cell(max(cycleList)*slicesPerStack,2);
