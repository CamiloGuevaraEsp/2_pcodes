...
patchwarp_path = '/Users/camilog/Downloads/PatchWarp-main';
addpath(genpath(patchwarp_path))

%% Specifiy source directory and saving directory
% Image data needs to be tiff stack files.
ops.source_path = '/Users/camilog/Downloads/test_images/TSeries-11082022-1509-1030/slice_3_folder';    % Directory that contains original tiff stack files
ops.save_path = '/Users/camilog/Downloads/test_images/TSeries-11082022-1509-1030/slice_3_folder/corrected';    % Directory where motion corrected images will be saved
